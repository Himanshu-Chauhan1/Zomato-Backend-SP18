...
deliveryPartnerRouter.put('/deliverypartners/:deliveryPartnerId', [validate.updateDeliveryPartner], update);
deliveryPartnerRouter.get('/deliverypartners/filter', get);
deliveryPartnerRouter.get('/deliverypartners', index);
deliveryPartnerRouter.delete('/deliverypartners/:deliveryPartnerId', [validate.deleteDeliveryPartner], destroy);
